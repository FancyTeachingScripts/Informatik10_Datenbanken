...
\begin{itemize}
    ...
    \item Zusätzlich zur Arbeit im Informatik-Unterricht wird auch \emphColB{Arbeit zuhause} notwendig sein. \emphColB{Arbeitsteilung ist erwünscht!}
...
\begin{itemize}
    ...
    \item 5 funktionale und 3 nicht-funktionale Anforderungen (\emphColB{Lastenheft})
    \item mindestens 2 User Stories (\emphColB{Lastenheft})
...
\begin{itemize}
    ...
    \item Zuordnung der Inhalt zu den Anforderung aus dem Lastenheft (\emphColB{Pflichtenheft}).
\end{itemize}
...
\begin{itemize}
    ...
    \item \emphColA{Achtung: } Nach einer Änderung des Datenbankmodells in YoungDB muss eine neue Datenbank generiert und alle Datensätze neu eingetragen werden! 
\end{itemize}
