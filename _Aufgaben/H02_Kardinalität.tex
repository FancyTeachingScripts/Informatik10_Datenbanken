...
\begin{itemize}
    ...
    \item \emphColA{m:n}, z.B. \LoesungLuecke{mehrere}{4cm} Lehrer pro Schulklasse + \LoesungLuecke{mehrere}{4cm} Schulklassen pro Lehrer (in Datenbanken nicht direkt umsetzbar, dazu später mehr).
\end{itemize}
}